...
test("keeps the finished game free of starter preview code", async () => {
  ...
  assert.match(page, /resetCombatInput/);
  ...
  assert.match(page, /finishCameraX/);
  ...
  assert.match(page, /enemy\.spawnWarmup = storyEntry \? randomBetween\(1\.8, 2\.6\) : randomBetween\(1\.15, 1\.9\)/);
  ...
  assert.match(page, /playerExiting/);
  assert.match(page, /stageClear/);
  assert.match(page, /beginPlayerDying/);
  assert.match(page, /beginPlayerExit/);
  assert.match(page, /updatePlayerDying/);
  assert.match(page, /updatePlayerExiting/);
  assert.match(page, /emitAircraftDamageSmoke/);
  assert.match(page, /showBattleUi/);
  assert.match(page, /pause-toggle/);
  assert.match(page, /pause-action/);
  ...
  assert.match(page, /ww2PropellerProfiles/);
  ...
  assert.match(page, /const entryDistance = storyEntry \? randomBetween\(760, 1120\) : randomBetween\(360, 760\)/);
  assert.match(page, /const storyForward = firstStoryContact \? randomBetween\(760, 940\) : entryDistance/);
  assert.match(page, /enemy\.spawnWarmup = storyEntry \? randomBetween\(1\.8, 2\.6\) : randomBetween\(1\.15, 1\.9\)/);
